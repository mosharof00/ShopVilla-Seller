...
class ColorName {
  ...
  /// Color: #14C38E
  static const Color green = Color(0xFF14C38E);

  /// Color: #98D4B1
  static const Color greenLow = Color(0xFF98D4B1);

  /// Color: #14C38E
  static const Color onPrimary = Color(0xFF14C38E);

  /// Color: #06F8F4
  static const Color pest = Color(0xFF06F8F4);

  /// Color: #0A7197
  static const Color primaryColor = Color(0xFF0A7197);

  /// Color: #F8F9C7
  static const Color start = Color(0xFFF8F9C7);

  /// Color: #E57373FF
  static const Color textFieldErrorColor = Color(0xE57373FF);
